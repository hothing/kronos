...
/*     unused(test); */
    ...
    DWORD* pdst = (DWORD*)(const uint8_t*)&mem[dst + (dofs >> 5)];
    DWORD* psrc = (DWORD*)(const uint8_t*)&mem[src + (sofs >> 5)];
...
/*     unused(test); */
    ...
    dofs += bits - 1;
    sofs += bits - 1;
    DWORD* pdst = (DWORD*)(uint8_t*)&mem[dst];
    DWORD* psrc = (DWORD*)(uint8_t*)&mem[src];
